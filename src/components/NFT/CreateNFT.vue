<template>
    <div class="container mx-auto text-left px-40 pt-20 text-gray-300 space-y-20">
        <div class=" ">
            ...
            <p class="my-10">You can set preferred display name, create your profile URL and manage other personal settings.
            </p>
        </div>
                ...
                <div class="space-y-1 text-center">
                    ...
                    <div v-if="showUploadCover" class="flex text-sm text-gray-600">
                        <label for="file-upload"
                            ...
                            <input id="file-upload" multiple :name="uploadFieldName" type="file" class="sr-only" @change="
                                coverFileChange(
                                    $event.target.name,
                                    $event.target.files
                                )
        ...
        <div>
            <label for="about" class="block font-medium text-3xl">
                Description
            </label>
            <div class="mt-1">
                <textarea v-model="description" rows="3"
                    class="shadow-sm bg-transparent focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md"
