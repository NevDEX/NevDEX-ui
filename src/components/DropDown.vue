<template>
  <div class="flex justify-center items-center -z-10 bg-transparent h-full group">
        ...
        <MenuButton
          ...
          <div class="flex flex-row h-6 justify-center">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"
              class="default-transition h-6 w-6 rotate-360 transform ml-4  group-hover:rotate-180">
