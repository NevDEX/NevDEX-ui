    ...
    <div class="relative w-auto my-6 mx-auto max-w-sm">
      <div class="relative rounded-lg shadow bg-gray-800">
        ...
        <div class="py-4 px-6 rounded-t border-b border-gray-600">
          <h3 class="text-base font-semibold text-gray-200 lg:text-xl">Withdraw</h3>
        </div>
        ...
        <div class="flex flex-row justify-between">
          <div class="px-6 text-white text-xs">Account Balance</div>
        ...
        <div class="mt-10 px-6 flex justify-center items-center pb-4">
          <button class="py-2 w-full bg-gray-500 hover:bg-gray-400 text-gray-50" @click="onWithdraw">Withdraw</button>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  props: ['withdrawToken'],
  created() {
    this.selectedToken.name = this.withdrawToken
  },
  methods: {
