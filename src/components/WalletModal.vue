  ...
  <div tabindex="-1" aria-hidden="false" class="overflow-x-hidden overflow-y-auto inset-0 fixed z-50 h-modal justify-center items-center pt-40">
    <div class="relative w-auto my-6 mx-auto max-w-sm">
      <div class="relative rounded-lg shadow bg-gray-800">
        ...
        <div class="py-4 px-6 rounded-t border-b border-blue-600">
          <h3 class="text-base font-semibold text-gray-200 lg:text-xl">Connect wallet</h3>
        </div>
        <div class="p-6">
          <ul class="my-4 space-y-3">
            <li @click="onConnect">
              <a href="#" class="flex items-center p-3 text-base font-bold text-gray-900 bg-gray-600 rounded-lg hover:bg-gray-100 group hover:shadow">
            ...
            <li>
              <a href="#" class="flex items-center p-3 text-base font-bold text-gray-900 bg-gray-600 rounded-lg hover:bg-gray-100 group hover:shadow">
                <svg class="h-5" viewBox="0 0 292 292" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M145.7 291.66C226.146 291.66 291.36 226.446 291.36 146C291.36 65.5541 226.146 0.339844 145.7 0.339844C65.2542 0.339844 0.0400391 65.5541 0.0400391 146C0.0400391 226.446 65.2542 291.66 145.7 291.66Z" fill="#3259A5"></path>
                  <path
...
export default {
  methods: {
    ...
    async onConnect() {
      try {
        await connectWithEther()
        if (walletGlobal.account !== '') {
          this.updateAccount(walletGlobal.account)
        }
      } catch (error) {
