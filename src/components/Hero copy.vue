  ...
  <div class="flex flex-col text-center mass-header z-10 bg">
    ...
    <div class="z-10 flex flex-col md:p-0 p-5 bg">
      ...
      <div class="flex justify-center items-start">
        <router-link to="trade"> <button class="text-gray-50 md:mt-40 mt-40 px-10 py-5 font-bold bg-gray-800 hover:bg-gray-500 rounded-md">Trade Now</button></router-link>
      </div>
