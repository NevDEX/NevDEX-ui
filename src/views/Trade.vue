            ...
            <div class="p-2 bg-gray-900 h-full">
              ...
              <div class="pt-2 text-sm font-medium text-center text-gray-500 border-b border-gray-600">
                <ul class="flex flex-wrap -mb-px">
                  <li class="mr-2">
                    <a href="javascript:void(0)" class="inline-block p-2 rounded-t-lg border-b-2 border-transparent hover:text-gray-300 hover:border-gray-300" @click="tabOrderType('market')" v-bind:class="{ 'border-gray-300 text-gray-300': orderType === 'market' }">Market</a>
                  </li>
                  <li class="mr-2">
                    <a href="javascript:void(0)" class="inline-block p-2 rounded-t-lg border-b-2 border-transparent hover:text-gray-300 hover:border-gray-300" @click="tabOrderType('limit')" v-bind:class="{ 'border-gray-300 text-gray-300': orderType === 'limit' }">Limit</a>
                  </li>
                </ul>
              </div>
              <!-- order type -->
