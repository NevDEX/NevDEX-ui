<template>
  ...
  <div class="pb-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-4 mt-20 container mx-auto w-screen px-20 mb-36  ">
    <div class="p-6 bg-gray-800 rounded-lg border border-gray-900 shadow-md mx-auto my-0 w-[90%]  ">
...
import MarketMarqueeText from '../components/MarketMarqueeText.vue'
