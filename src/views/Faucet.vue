      ...
      <div class="w-full">
        <div class="" style="width: 640px;">
          ...
          <div class="relative">
            ...
            <button class="text-white absolute right-2.5 bottom-2.5 focus:outline-none font-medium text-sm px-4 py-2 bg-gray-800 hover:bg-gray-600 focus:ring-blue-800" @click="onFaucet">Give me Token</button>
          </div>
        </div>
      </div>
    </div>
